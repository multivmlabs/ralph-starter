...
const DEMO_SCENARIOS: DemoScenario[] = [
  ...
  },
  {
    ...
    outputLines: [
      '  GitHub Issues',
      '? Select a repository: myorg/api',
      '? Select issues: #42 — Add user authentication [feature]',
  ...
  },
  {
    ...
    outputLines: [
      '  Linear Issues',
      '? Select a team: Engineering (ENG)',
      '? Select an issue: ENG-42 — Dark mode toggle (In Progress)',
  ...
  },
  {
    ...
    outputLines: [
      '  Notion Pages',
      '? Search for a page: API Spec',
      '? Select a page: API Spec (workspace)',
